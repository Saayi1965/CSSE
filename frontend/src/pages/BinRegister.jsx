...
export default function BinRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newBin = {
      ...
      fillLevel: 0,
      lastCollected: null,
      nextCollection: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
      qrData: `SMARTWASTE:${binId}:${formData.binType}:${formData.lat.toFixed(6)}:${formData.lng.toFixed(6)}`,
    };
  ...
  const nextStep = () => {
    if (
      ...
      toast.error("⚠️ Please complete all personal info");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex flex-col items-center px-4 py-8">
      ...
      <motion.div initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-8">
        ...
        <p className="text-gray-600 text-lg max-w-2xl">
          Register your waste bin for smart monitoring and efficient collection services
        </p>
      </motion.div>
        ...
        <div className="flex items-center justify-between mb-4">
          {[1, 2, 3].map((step) => (
            <div key={step} className="flex items-center">
              ...
              {step < 3 && (
                <div className={`w-24 h-1 mx-2 ${step < currentStep ? "bg-emerald-500" : "bg-gray-200"}`} />
              )}
            </div>
          ))}
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {currentStep === 1 && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-gray-700 font-semibold mb-3">Owner / Organization Name *</label>
                  <input
                    type="text"
                    name="ownerName"
                ...
                <div>
                  <label className="block text-gray-700 font-semibold mb-3">Resident Type *</label>
                  <select
                    name="residentType"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-gray-700 font-semibold mb-3">Collection Frequency *</label>
                  <select
          ...
          {currentStep === 2 && (
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-gray-700 font-semibold mb-3">Waste Type *</label>
                  <select
                    name="binType"
                ...
                <div>
                  <label className="block text-gray-700 font-semibold mb-3">Bin Size *</label>
                  <select
                    name="binSize"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-3">Location Description</label>
                <input
                  type="text"
                  name="location"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-3">Full Address</label>
                <input
                  type="text"
                  name="address"
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-amber-700 text-sm">
                      Click on the map to place your bin location marker accurately.
                    </p>
                  </div>
                </div>
              </div>
...
<LocationMarker />
          ...
          {formData.lat && (
            <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
              <p className="text-emerald-700 font-semibold">📍 Selected Coordinates:</p>
  ...
  {/* Registered Bins */}
  {loadingBins ? (
    <p className="text-gray-500 mt-8">Loading your bins...</p>
  ) : bins.length > 0 ? (
    <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="mt-12 w-full max-w-6xl">
        ...
        {bins.map((bin, index) => (
          ...
          >
            ...
            <div className="space-y-2 text-sm text-gray-600 mb-4">
              ...
              <p><strong>Type:</strong> {bin.residentType}</p>
    ...
    <p className="text-gray-500 mt-8">No bins registered yet.</p>
  )}

  <p className="text-gray-500 text-sm mt-12 text-center">
    © 2024 Smart Waste Management System | Sustainable Solutions for Cleaner Communities 🌱
  </p>
</div>
